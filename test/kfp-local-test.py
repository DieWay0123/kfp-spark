...
def test_kubectl_apply_local(file_path: str):
  import subprocess
  import json
  import time
...
def kubectl_apply_pipeline(file_path: str):
  kubectl_apply_task = test_kubectl_apply_local(file_path=file_path)
...
if __name__ ==  '__main__':
  ...
  kubectl_apply_pipeline(file_path='/home/k8master/Documents/sparkTest/pyspark-pi.yaml')
